...
/**
 * This function handles the sorting of the products by setting the selected sort option in the store.
 * @param {Event} event - The event object from the change event.
 */
const handleSortChange = (event) => {
  productStore.setSortOption(event.target.value);
};
</script>
...
<template>
  <div class="flex sm:w-[95%] max-w-[21rem] md:w-full">
    ...
    <select 
      ...
      :value="productStore.getCurrentSort" 
